...
public class TurDeviceData {
   ...
   public void readFromFile(final FileInputStream fileRawData) throws NumberFormatException {
      ...
      fileVersion = TurFileUtil.readText(fileRawData) + UI.SYMBOL_DOT +
      ...
      final int lineCount = Integer.parseInt(TurFileUtil.readText(fileRawData));
