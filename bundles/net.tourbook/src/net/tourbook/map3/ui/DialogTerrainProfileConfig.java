...
public class DialogTerrainProfileConfig {
   ...
   private static final String      STATE_TERRAIN_PROFILE_FOLLOW           = STATE_PREFIX + "FOLLOW";           //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_DIMENSION        = STATE_PREFIX + "DIMENSION";        //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_KEEP_PROPORTIONS = STATE_PREFIX + "KEEP_PROPORTIONS"; //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_ZERO_BASED       = STATE_PREFIX + "ZERO_BASED";       //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_SHOW_EYE         = STATE_PREFIX + "SHOW_EYE";         //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_PROFILE_LENGTH   = STATE_PREFIX + "PROFILE_LENGTH";   //$NON-NLS-1$
   private static final String      STATE_TERRAIN_PROFILE_IS_TOOLTIP_MOVED = STATE_PREFIX + "IS_TOOLTIP_MOVED"; //$NON-NLS-1$
   ...
   private void createUI(final Composite parent) {
      ...
      parent.addDisposeListener(disposeEvent -> saveState());
...
//				_spinnerProfileLength.setToolTipText(Messages.Terrain_Profile_Label_ProfileLength);
            _spinnerProfileLength.addSelectionListener(widgetSelectedAdapter(
                  selectionEvent -> onModify()));
            _spinnerProfileLength.addMouseWheelListener(mouseEvent -> {
