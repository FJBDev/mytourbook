...
public class ElevationCompareManager {
         ...
         if (queueItem_TourId != null) {
            ...
            if (compareTourData != null
               ...
               for (int refTourIndex = 0; refTourIndex < _allRefTourItems_FromLastCompare.size(); refTourIndex++) {
                  ...
                  // compare the tour
                  final TVIElevationCompareResult_ComparedTour compareResult = compareTours_OneTour(
                        refTourItem,
   ...
   /**
    * @param refId
    * @return Returns a {@link TVIRefTour_RefTourItem} for the refId or <code>null</code> when not
    *         available
    */
    ...
    */
   public static TVIElevationCompareResult_ComparedTour[] getComparedTours() {

      return _allComparedTourItems.toArray(new TVIElevationCompareResult_ComparedTour[_allComparedTourItems.size()]);
   }
   ...
   static Object navigateTour(final boolean isNextTour) {
       ...
       */
      final IViewPart comparedTours = activePage.findView(ElevationCompareResultView.ID);

      if (comparedTours instanceof ElevationCompareResultView) {

         navigatedTour = ((ElevationCompareResultView) comparedTours).navigateTour(isNextTour);
      }
      ...
      Display.getDefault().asyncExec(() -> {
         ...
         if (window != null) {
            ...
            try {
               ...
               final ElevationCompareResultView view = (ElevationCompareResultView) Util.showView(
                     ElevationCompareResultView.ID,
                     true);
