...
public class PrefPageExportKml extends PreferencePage implements IWorkbenchPreferencePage {

   public static final String  ID                  = "net.tourbook.preferences.PrefPageExport";  //$NON-NLS-1$
...
//       // hide these components
   ...
   //TODO FB : https://github.com/denapp/turtlesport/blob/master/src/fr/turtlesport/googleearth/GoogleEarthWin.java
   ...
   private Composite createUI_20_Speed(final Composite parent) {
...

      {
         ...
         _lblIgnorSpeedValues_Info.setText(".PrefPage_Fit_Label_IgnoreSpeedValues_Info");
      }
   ...
   protected void performDefaults() {
       ...
       * _chkIgnoreSpeedValues.setSelection(_prefStore.getDefaultBoolean(IPreferences.
       * FIT_IS_IGNORE_SPEED_VALUES));
       * } else if (selectedTab == TAB_FOLDER_TEMPERATURE) {
       * final float temperatureAdjustment =
       * _prefStore.getDefaultFloat(IPreferences.FIT_TEMPERATURE_ADJUSTMENT);
       * _spinnerTemperatureAdjustment.setSelection((int) (temperatureAdjustment *
       * TEMPERATURE_DIGITS));
       ...
       * _comboPowerDataSource.select(_prefStore.getDefaultInt(IPreferences.
       * FIT_PREFERRED_POWER_DATA_SOURCE));
       * }
       */
      enableControls();
   ...
   private void restoreState() {
      ...
      /*
       * // speed
       * _chkIgnoreSpeedValues.setSelection(_prefStore.getBoolean(IPreferences.
       * FIT_IS_IGNORE_SPEED_VALUES));
       * // temperature
       * final float temperatureAdjustment =
       * _prefStore.getFloat(IPreferences.FIT_TEMPERATURE_ADJUSTMENT);
   ...
   private void saveState() {
      ...
      /*
       * // speed
       * _prefStore.setValue(IPreferences.FIT_IS_IGNORE_SPEED_VALUES,
       * _chkIgnoreSpeedValues.getSelection());
       * // temperature
       * final float temperatureAdjustment = _spinnerTemperatureAdjustment.getSelection() /
       * TEMPERATURE_DIGITS;
       * _prefStore.setValue(//
